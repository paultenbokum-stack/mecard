...
class Module {
    ...
    /**
 * Preview: wraps the existing Pro preview (unchanged markup) and optionally shows a Standard preview with a toggle.
 * The toggle/visibility is controlled by JS based on the profile type (standard vs pro).
 */
public static function render_profile_preview_shell() : void {
    ?>
    <div id="mePreviewSwitcher" class="me-preview-switcher" data-mode="pro">

        <?php self::render_preview_toggle(); ?>

        <div class="me-preview-panes">
            <?php
            // Pro preview markup: keep as-is to avoid breaking existing styling and buttons.
            self::render_pro_preview_markup();
...
/**
 * Toggle UI (Standard / Pro). JS will hide this entirely when the profile is already Pro.
 */
private static function render_preview_toggle() : void {
    ?>
    <div class="me-preview-toggle" role="tablist" aria-label="Preview mode">
        <button type="button"
                class="me-preview-tab is-active"
                data-me-preview-tab="standard"
                role="tab"
                aria-selected="true">
            Standard
        </button>
        ...
        <button type="button"
                class="me-preview-tab"
                data-me-preview-tab="pro"
                role="tab"
                aria-selected="false">
            Pro
        </button>
