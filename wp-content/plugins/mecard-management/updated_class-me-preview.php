...
class Module {
    ...
    protected static function render_profile_preview_shell() : void {
        ?>
        <div class="me-preview-shell">

            <div class="me-preview-tabs btn-group btn-group-sm" role="group" aria-label="Preview mode">
                <button type="button" class="btn btn-light js-me-preview-tab is-active" data-me-preview="standard" id="mePreviewTabStandard">Standard</button>
                <button type="button" class="btn btn-light js-me-preview-tab" data-me-preview="pro" id="mePreviewTabPro">Pro</button>
            </div>

            <!-- STANDARD (only shown when profile type is NOT professional) -->
            <div id="mePreviewStandardPane" class="me-preview-pane is-active">
                <div id="standardPreview" class="preview-scope is-standard" data-me-preview-scope="standard">
                    <div class="me-phone-frame">
                        <div class="me-phone-screen">
                            ...
                            <div class="standard-profile-container">
                                ...
                                <!-- Social icons (mirrors shortcode output style) -->
                                <div class="container-md">
                                    ...
                                    <!-- Primary buttons (email / call / whatsapp) -->
                                    <div class="row mt-2">
                                        <div class="col-4 px-1">
                                            <a id="std-email" class="btn btn-block btn-sm btn-outline-primary" href="#" target="_blank" rel="noopener">Email</a>
                                        </div>
                                        <div class="col-4 px-1">
                                            <a id="std-call" class="btn btn-block btn-sm btn-outline-primary" href="#" target="_blank" rel="noopener">Call</a>
                                        </div>
                                        <div class="col-4 px-1">
                                            <a id="std-wa" class="btn btn-block btn-sm btn-outline-primary" href="#" target="_blank" rel="noopener">WhatsApp</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid mt-3">
                                    ...
                                    <div class="row" id="std-website-row" style="display:none;">
                                        ...
                                        <div class="col col-8"><a id="std-website-link" href="#" target="_blank" rel="noopener"><span id="std-website-text"></span></a></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col col-sm-12">
                                            <h3 class="company" id="std-company-name">Company name</h3>
                                            <p></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div id="std-company-address" class="mb-2"></div>

                                    <div class="d-flex flex-row justify-content-start flex-wrap">
                                        <div class="p-1" id="std-company-website-wrap" style="display:none;">
                                            <a id="std-company-website" href="#" target="_blank" rel="noopener">
                                                <button class="company website" type="button">Website</button>
                                            </a>
                                        </div>

                                        <div class="p-1" id="std-company-phone-wrap" style="display:none;">
                                            <a id="std-company-phone" href="#" target="_blank" rel="noopener">
                                                <button class="company phone" type="button">Call</button>
                                            </a>
                                        </div>

                                        <div class="p-1" id="std-company-directions-wrap" style="display:none;">
                                ...
                                <div id="std-vcard-wrap">
                                    <div class="vcard-download">
                                        <div class="vcard-button" id="std-vcard-button">
            ...
            <!-- PRO -->
            <div id="mePreviewProPane" class="me-preview-pane">
                <div id="proPreview" class="preview-scope is-pro" data-me-preview-scope="pro">
                    <div class="me-phone-frame">
                        <div class="me-phone-screen">

                            <div class="pro-profile-container">

                                <!-- Upsell banner (hidden automatically if already professional) -->
                                <div class="me-pro-upsell alert alert-info mb-2" id="meProUpsell">
                                    <strong>Pro preview</strong> — upgrade to unlock this design on your live profile.
                                </div>
                                ...
                                <div class="container-md">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-4 px-1">
                                            <a id="pv-email" class="btn btn-block btn-sm btn-outline-primary" href="#" target="_blank" rel="noopener">Email</a>
                                        </div>
                                        <div class="col-4 px-1">
                                            <a id="pv-call" class="btn btn-block btn-sm btn-outline-primary" href="#" target="_blank" rel="noopener">Call</a>
                                        </div>
                                        <div class="col-4 px-1">
                                            <a id="pv-wa" class="btn btn-block btn-sm btn-outline-primary" href="#" target="_blank" rel="noopener">WhatsApp</a>
                                        </div>
                                    </div>
                                </div>

                                <!-- Pro-only: company name + rich description -->
                                <div class="company-name">
                                    <h3 class="m-0"><span id="pv-company-name">Company name</span></h3>
                                </div>

                                <div class="company-description" id="pv-company-description"></div>
